...
public class MainActivityforgotnuse extends AppCompatActivity {
...
SharedPreferences sh;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_main_newforgotnuse);
...
sh=getSharedPreferences("reg",MODE_PRIVATE);
  ...
  private void openActivity(String phoneNumber) {
    Intent verification = new Intent(this, VerificationActivityforgotnurse.class);
