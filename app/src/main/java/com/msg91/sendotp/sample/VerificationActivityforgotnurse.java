...
public class VerificationActivityforgotnurse extends AppCompatActivity implements
...
private static final int OTP_LNGTH = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verificationforgotnuse);
...
//                            .message("##OTP## is Your verification digits.")//##OTP## use for default generated OTP
    ...
    public void onVerified(String response) {
        //DataManaer.getInstance().hideProgressMessage();
      startActivity(new Intent(VerificationActivityforgotnurse.this,Resetpassnurse.class).putExtra("num",phoneNumber));
    }
    ...
    private void startTimer() {
        resend_timer.setClickable(false);
        resend_timer.setTextColor(ContextCompat.getColor(VerificationActivityforgotnurse.this, R.color.white));
        new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                resend_timer.setTextColor(ContextCompat.getColor(VerificationActivityforgotnurse.this, R.color.send_otp_blue));
            }
        }.start();
    }
