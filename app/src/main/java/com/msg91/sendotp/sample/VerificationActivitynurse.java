...
public class VerificationActivitynurse extends AppCompatActivity implements
...
SharedPreferences sh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verificationnuse);
...
//                            .message("##OTP## is Your verification digits.")//##OTP## use for default generated OTP
    ...
    public void onVerified(String response) {
        //DataManaer.getInstance().hideProgressMessage();
      startActivity(new Intent(VerificationActivitynurse.this,Registrationnurse.class));
    }
    ...
    private void startTimer() {
        resend_timer.setClickable(false);
        resend_timer.setTextColor(ContextCompat.getColor(VerificationActivitynurse.this, R.color.white));
        new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                resend_timer.setTextColor(ContextCompat.getColor(VerificationActivitynurse.this, R.color.send_otp_blue));
            }
        }.start();
    }
