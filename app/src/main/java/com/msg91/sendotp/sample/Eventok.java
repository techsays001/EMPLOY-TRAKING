...
loadProducts();
    ...
    private void loadProducts() {
         ...
         * */
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/Employ_Tracking_office/location_find.php",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = array.length()-1; i >=0; i--) {
                                ...
                                productList.add(new Cheque5(
                                        product.getString("address"),
                                        product.getString("time_date")
                            ...
                            Chequeadapter5 adapter = new Chequeadapter5(Eventok.this, productList);
