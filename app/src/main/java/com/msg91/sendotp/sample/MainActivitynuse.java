...
public class MainActivitynuse extends AppCompatActivity {
...
SharedPreferences sh;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_main_newnuse);
  ...
  private void openActivity(String phoneNumber) {
    Intent verification = new Intent(this, VerificationActivitynurse.class);
